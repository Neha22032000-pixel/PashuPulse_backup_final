...
os.environ.setdefault("PASHU_SAATHI_TRAIN_MODE", "full")
os.environ.setdefault("PASHU_SAATHI_OUT_DIR", "/kaggle/working/pashu_pulse_low_lr_from_ckpt250_v1")
os.environ.setdefault("PASHU_SAATHI_CONTINUE_FROM_CHAMPION", "true")
os.environ.setdefault("PASHU_SAATHI_RESUME_ADAPTER", "/kaggle/input/pashupulse-sft-checkpoint-adapters/checkpoint-250")
os.environ.setdefault("PASHU_SAATHI_MAX_SEQ_LENGTH", "768")
os.environ.setdefault("PASHU_SAATHI_BATCH_SIZE", "1")
os.environ.setdefault("PASHU_SAATHI_GRAD_ACCUM", "8")
os.environ.setdefault("PASHU_SAATHI_LEARNING_RATE", "3e-5")
os.environ.setdefault("PASHU_SAATHI_MAX_STEPS", "75")
os.environ.setdefault("PASHU_SAATHI_EVAL_STEPS", "25")
os.environ.setdefault("PASHU_SAATHI_SAVE_STEPS", "25")
os.environ.setdefault("PASHU_SAATHI_SAVE_TOTAL_LIMIT", "3")
os.environ.setdefault("PASHU_SAATHI_LORA_R", "16")
os.environ.setdefault("PASHU_SAATHI_LORA_ALPHA", "16")
os.environ.setdefault("PASHU_SAATHI_LORA_DROPOUT", "0.0")
os.environ.setdefault("PASHU_SAATHI_REQUIRED_GPU_NAME", "t4")
import hashlib
